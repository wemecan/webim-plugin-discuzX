...
cache:false,url:H("leave"),dataType:"jsonp",data:{ticket:g.ticket,id:e,nick:l.nick}});this.trigger("leave",[j])}},clear:function(){}})})();ma("history",{},{_init:function(){this.data=this.data||{};this.data.chat=this.data.chat||{};this.data.grpchat=this.data.grpchat||{}},get:function(e,g){return this.data[e][g]},set:function(e){var g=this.data,j={chat:{},grpchat:{}};e=ka(e);var l=e.length,o,v,t=this.options.userInfo.id;if(l){for(var u=0;u<l;u++){o=e[u];J=o.type;if((v=J=="chat"?o.to==t?o.from:o.to:
o.to)&&J){j[J][v]=j[J][v]||[];j[J][v].push(o)}}for(var J in j)for(v in j[J]){o=j[J][v];if(g[J][v]){g[J][v]=g[J][v].concat(o);this._triggerMsg(J,v,o)}else this.load(J,v)}}},_triggerMsg:function(e,g,j){this.trigger(e,[g,j])},clear:function(e,g){this.data[e][g]=[];this.trigger("clear",[e,g]);W({url:H("clear"),type:"get",cache:false,dataType:"jsonp",data:{type:e,id:g}})},download:function(e,g){var j=H("download"),l=A.createElement("iframe"),o=new Date,v=[];o={id:g,type:e,time:(new Date).getTime(),date:o.getFullYear()+
"-"+(o.getMonth()+1)+"-"+o.getDate()};for(var t in o)v[v.length]=encodeURIComponent(t)+"="+encodeURIComponent(o[t]);j+=(/\?/.test(j)?"&":"?")+v.join("&");l.setAttribute("src",j);l.style.display="none";A.body.appendChild(l)},init:function(e,g,j){if(qa(j)){this.data[e][g]=j;this._triggerMsg(e,g,j)}},load:function(e,g){var j=this;j.data[e][g]=[];W({url:H("history"),cache:false,type:"get",dataType:"jsonp",data:{type:e,id:g},success:function(l){j.init(e,g,l)}})}})})(window,document);
